...
import { pollForCallEnd, pollForTranscript } from "@/utils/callPolling";
...
const protocols = [
  {
    ...
    status: "Active",
    description: "Policy update calls",
  },
  {
    id: "2",
    name: "Appointment Reminders",
    status: "Active",
    description: "Remind patients of appointments",
  },
  {
    id: "3",
    name: "Clinic Feedback Survey",
    status: "Draft",
    description: "Collect feedback from patients",
  },
];
...
const postVisitCareTemplate = [
  {
    question:
      "We're following up on your recent visit with {{provider_name}} on {{appointment_date}} at {{clinic_location}}. Ask for feedback.",
    response:
      "Positive: We're glad to hear that!\n Negative or unsure: feedback is passed along to the clinic team.",
    placeholder: "Enter a question for the voice agent to ask...",
    responsePlaceholder:
      "Let the voice agent know how you want it to respond....",
    expanded: true,
  },
  {
    question: "Since appointment, have any symptoms worsened or changed",
    response:
      "Yes: Recommend calling the clinic to speak with your provider as soon as possible.\nNo: If anything changes, feel free to contact clinic.",
    placeholder: "Enter a question for the voice agent to ask...",
    responsePlaceholder:
      "Let the voice agent know how you want it to respond....",
    expanded: true,
  ...
  {
    question:
      "Would you like us to schedule a follow-up appointment, or would you prefer the clinic to contact you to check in?",
    response:
      "Yes: I'll let the clinic know you'd like to follow up.\nNo: Okay — no action needed. ",
    placeholder: "Enter a question for the voice agent to ask...",
    responsePlaceholder:
      "Let the voice agent know how you want it to respond....",
    expanded: true,
...
const appointmentReminderTemplate = [
  {
    question:
      "Inform the patient of the {{appointment_date}} and the {{clinic_location}}. Ask the patient if this appointment still works for them.",
    response:
      "If the patient indicates that the appointment still works for them, provide thanks and end the call.\n\nIf the patient indicated that the appointment doesn't work, continue forward.",
    placeholder: "Enter a question for the voice agent to ask...",
    responsePlaceholder:
      "Let the voice agent know how you want it to respond....",
    expanded: true,
...
const billingFollowupTemplate = [
  {
    question:
      "Notify the patient of a billing issue or overdue balance related to their recent appointment.",
    response:
  ...
  {
    question:
      "Ask if the patient would like to pay over the phone, receive a callback, or handle it online.",
    response:
      "If phone payment requested, route to live agent or collect callback preference.\nIf online preferred, provide the website or send a follow-up message.",
    placeholder: "Enter a question for the voice agent to ask...",
    responsePlaceholder:
      "Let the voice agent know how you want it to respond....",
    expanded: true,
  ...
  {
    question:
      "Check if the patient has any questions or needs help understanding the bill.",
    response:
      "If yes, offer to connect with billing support.\nIf no, end call politely.",
    placeholder: "Enter a question for the voice agent to ask...",
    responsePlaceholder:
      "Let the voice agent know how you want it to respond....",
    expanded: true,
...
const preProcedureColonoscopyTemplate = [
  {
    question:
      "Confirm that the patient is scheduled for a colonoscopy on a specific date with their provider.",
    response:
      "If confirmed, continue to next steps.\nIf denied or unsure, end call or redirect to support.",
    placeholder: "Enter a question for the voice agent to ask...",
    responsePlaceholder:
      "Let the voice agent know how you want it to respond....",
    expanded: true,
  ...
  {
    question:
      "Verify whether the patient has begun following the low-fiber diet as instructed in the days leading up to the procedure.",
    response:
  ...
  {
    question:
      "Ask if the patient understands that they must follow a clear liquid diet the day before the procedure.",
    response:
  ...
  {
    question:
      "Confirm that the patient has picked up and plans to take the bowel prep solution or laxative as instructed.",
    response:
      "If yes, end call positively.\nIf no, recommend prompt pickup and review of instructions.",
    placeholder: "Enter a question for the voice agent to ask...",
    responsePlaceholder:
      "Let the voice agent know how you want it to respond....",
    expanded: true,
...
const DropTextarea = ({
  ...
  return (
    <textarea
      ...
      className={`w-full border border-black rounded-md px-3 py-2 text-lg mb-2 bg-white text-black ${
        className || ""
      }`}
      value={value}
      onChange={(e) => {
          ...
          <div className="bg-white rounded-lg shadow-sm p-8 max-w-5xl mx-auto">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  onClick={async () => {
                    ...
                    const selectedPatientIds = Object.keys(assigned).filter(
                      (id) => assigned[id]
                    );
                    ...
                    if (!agentId) {
                      toast.error(
                        "Please select a template to set the agent type."
                      );
                      return;
                    }
                    ...
                    for (const patient of selectedPatients) {
                      try {
                        ...
                        if (response.ok) {
                          ...
                          pollForCallEnd(callId, patient.name, name); // name is the protocol name
                          pollForTranscript(callId, patient.name, name);
                          toast.success(
            ...
            <div className="mb-6">
              <div className="flex border border-[#264653] rounded-lg overflow-hidden">
                {["General Info", "Call Script", "Voice Settings"].map(
                  (tab) => (
                    <button
                      key={tab}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                  ...
                  <div>
                    ...
                    <select className="w-full border rounded-md px-3 py-2 text-sm bg-white">
                      <option>
                        Define when the calls should take place...
                      </option>
                  ...
                  onDrop={() =>
                    setQuestionBlocks((blocks) => [
                      ...blocks,
                      {
                        ...
                        response: "",
                        placeholder:
                          "Enter a question for the voice agent to ask...",
                        responsePlaceholder:
                          "Let the voice agent know how you want it to respond....",
                        expanded: true,
                      },
                ...
                >
                  {questionBlocks.length === 0 ? (
                    ...
                    questionBlocks.map((block, idx) => (
                      <div
                        key={idx}
                        className={`bg-white border border-black rounded-lg p-4 relative mb-4 ${
                          block.expanded ? "" : "cursor-pointer"
                        }`}
                      >
                        ...
                        {block.expanded && (
                          <>
                            ...
                            <div className="bg-[#f7f8fa] border border-black rounded-md p-3 mt-2">
                              <div className="text-sm font-normal mb-1 text-black">
                                Response Handling
                              </div>
                              <DropTextarea
                        ...
                        {showTemplateDropdown && (
                          <div className="absolute right-0 mt-2 w-48 bg-white border rounded shadow z-10">
                            ...
                            <button
                              ...
                              onClick={() => {
                                setQuestionBlocks(
                                  preProcedureColonoscopyTemplate
                                );
                        ...
                        <span className="mb-2">
                          ...
                          >
                            <g clipPath="url(#clip0_366_1202)">
                              <path
                                d="M12.6603 14.6366C12.34 13.9765 11.9259 13.496 11.2111 13.789L9.80091 14.3124C8.67201 14.8358 8.10951 14.3124 7.54701 13.5272L5.01185 7.7538C4.69544 7.09364 4.85951 6.47255 5.57435 6.17958L7.54701 5.39443C8.26185 5.10146 8.14857 4.48036 7.82826 3.82021L6.13685 0.671769C5.81654 0.0116131 5.16029 -0.148543 4.44544 0.144426C3.01576 0.738176 1.83216 1.66005 1.06654 3.03114C0.129039 4.70693 0.597789 7.03505 0.785289 8.01552C0.972789 8.99599 1.62904 10.7108 2.47669 12.4765C3.32435 14.2421 4.06654 15.6288 4.7306 16.414C5.39466 17.1991 6.98451 19.3476 8.95716 19.8241C10.5744 20.2147 12.3165 19.8866 13.7462 19.2968C14.4611 19.0038 14.465 18.3827 14.1447 17.7186L12.6603 14.6366ZM16.6525 4.61318H14.3439L17.422 7.6913H10.5001V9.23036H17.422L14.3478 12.3046H16.6564L20.504 8.45693L16.6525 4.61318Z"
                                fill="black"
                              />
                            </g>
                            <defs>
